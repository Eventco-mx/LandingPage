      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border border-purple-100">
        <div className="text-center py-8">
          ...
          <p className="text-gray-600">
            Nos pondremos en contacto contigo pronto para darte más información sobre cómo unirte a EVENT.CO como proveedor.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg border border-purple-100">
      ...
      <p className="text-gray-600 mb-6">
        Sé de los primeros en ofrecer tus servicios en EVENT.CO y aumenta tus ventas
      </p>
      
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <Label htmlFor="provider-name">Nombre del proveedor / empresa</Label>
          <Input id="provider-name" placeholder="Nombre de tu negocio" required />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select required>
            ...
            <SelectContent>
              ...
              <SelectItem value="animacion">Animación/Entretenimiento</SelectItem>
        ...
        <div className="space-y-2">
          ...
          <Input id="provider-email" type="email" placeholder="tu@negocio.com" required />
        </div>
        
        <div className="space-y-2">
          <Label htmlFor="provider-phone">Teléfono</Label>
          <Input id="provider-phone" type="tel" placeholder="Tu número de contacto" required />
        </div>
        
        <div className="space-y-2">
          <Label htmlFor="provider-city">Ciudad</Label>
          <Input id="provider-city" placeholder="¿Dónde ofreces tus servicios?" required />
        </div>
