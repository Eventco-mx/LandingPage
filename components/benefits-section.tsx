...
export default function BenefitsSection() {
  const benefits = [
    ...
    },
    {
      ...
      description: "Realiza pagos seguros y ten la tranquilidad de que tu evento está respaldado por nuestra garantía.",
    },
    {
    ...
    },
    {
      ...
      description: "Nuestro equipo está disponible para ayudarte antes, durante y después de tu evento.",
    },
  ]
    ...
    <section id="benefits-section" className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900">¿Por qué elegir EVENT.CO?</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-purple-50 p-6 rounded-xl hover:shadow-md transition-shadow">
